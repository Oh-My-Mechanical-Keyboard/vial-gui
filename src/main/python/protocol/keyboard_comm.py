...
from protocol.yr_mag import ProtocolYrMag
...
class Keyboard(ProtocolMacro, ProtocolDynamic, ProtocolTapDance, ProtocolCombo, ProtocolKeyOverride, ProtocolYrMag):
